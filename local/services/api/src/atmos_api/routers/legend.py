...
def nexrad_legend(
    ...
    The ingestion pipeline stores metadata under:
        derived/nexrad/{SITE}/{TIMESTAMP_KEY}/meta.json
    """
    bucket = settings.derived_bucket
    object_name = f"derived/nexrad/{site.upper()}/{timestamp_key}/meta.json"
